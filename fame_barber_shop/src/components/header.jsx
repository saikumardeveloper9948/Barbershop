      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          <button
            ...
            className="dark:text-white text-gray-900 hover:text-amber-500  dark:hover:text-amber-500 transition duration-300"
          >
            Home
          </button>
          <button
      ...
      >
        <div className="container mx-auto px-4">
          <nav className="flex flex-col space-y-2 py-3">
            <button
              onClick={() => scrollToSection("home")}
              className="px-3 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700 text-left"
            >
              Home
            </button>
            <button
            ...
            <button
              onClick={toggleMobileMenu}
              className="w-full px-3 py-2 rounded-md text-base font-medium bg-amber-500 hover:bg-amber-600 text-white transition duration-300 mt-2"
            >
              Book Appointment
            </button>
          </nav>
