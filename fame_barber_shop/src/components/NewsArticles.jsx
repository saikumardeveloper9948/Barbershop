...
const NewsArticles = () => {
  const articles = [
    {
      image:
        "https://www.beautster.com/blog/wp-content/uploads/2020/11/dye-your-hair-several-times.jpg",
      category: "Grooming",
    ...
    {
      image:
        "https://img.freepik.com/free-photo/working-process-barbershop_1163-2025.jpg",
    ...
    {
      image:
        "https://media.allure.com/photos/67411e46c48f68cf66efadde/16:9/w_3488,h_1962,c_limit/allure-hair-trend-2024-3%20copy%20(1).jpg",
    ...
    {
      image:
        "https://www.impactcosmetic.com/wp-content/uploads/2023/06/6-Reasons-Why-Men-Should-Get-Facials.jpg",
      category: "Skincare",
    ...
    {
      image:
        "https://content.jdmagicbox.com/comp/def_content/hair-spas/7-hair-spas-7-69g4b.jpg",
      category: "Salon Talk",
    ...
    <section className="py-16 bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-300">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div>
            <h2 className="text-4xl font-bold mt-2 text-black dark:text-amber-500">
              News & Articles
            </h2>
          </div>
        </div>
          ...
          <div className="animate-marquee-reverse ">
            <div className="inline-flex space-x-8">
              {articles.map((article, index) => (
                <div
                  key={index}
                  className="w-[400px] bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border-2 border-gray-200 dark:border-gray-700 hover:border-amber-500 dark:hover:border-amber-500 transition-colors duration-300"
                >
                  <img
                    src={article.image}
                    alt={article.title}
