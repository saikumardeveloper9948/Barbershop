    ...
    <section className="py-16 bg-slate-200 text-black dark:bg-slate-800 dark:text-white">
      <div className="container mx-auto px-4">
        <div className="text-center py-3 ">
          <h2 className="text-4xl text-center font-bold mt-2 mb-4 dark:text-amber-500">
            We Offer a Wide Range of Services
          </h2>
          <p className="text-gray-700 text-center px-20 dark:text-white">
          ...
          <div className="w-full md:w-1/2 space-y-8">
            <div className="space-y-6">
              {servicesList.map((service, index) => (
                <div
                  key={index}
                  className="border-b border-gray-700 pb-4 dark:border-gray-300"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold dark:text-amber-300 text-black mb-1">
                        {service.title}
                      </h3>
                      <p className="text-purple-800 text-sm dark:text-gray-100">
                        {service.description}
                      </p>
                    </div>
                  </div>
